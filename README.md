...
A guided breathing exercise for the browser, styled as a soft, card-based dashboard: a blue-gradient hero card holding a circle that expands and contracts with your breath, rounded stat cards, and pill buttons.
...
- A gentle completion screen

To use, open `breathing-exercise/index.html` in a browser.
